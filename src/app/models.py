...
class Generation(Base):
    ...
    image_url = Column(String(500), nullable=True)  # Preview image (512x512 upscaled)
    thumbnail_url = Column(String(500), nullable=True)
    blockbench_url = Column(String(500), nullable=True)  # Actual pixel art (16x16, 32x32, etc.)
